...
df = pd.read_csv("../preparacao_dados/clientes-v2.csv")
...
print("Estatística dos dados:\n", df.describe()) # df.describe = Mostra a estatística

df = df[["idade", "data", "estado", "salario", "nivel_educacao", "estado_civil", "area_atuacao"]]
print(df.head().to_string())
